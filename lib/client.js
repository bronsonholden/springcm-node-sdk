...
/**
 * SpringCM API client. Manages API requests, authentication, and other
 * internal state.
 * @constructor
 * @param {object} options - Authentication information and other settings.
 */
...
SpringCM.prototype.glob = require('./glob');
...
SpringCM.prototype.checkInDocument = require('./check-in-document');
